...
export function HandHeartIcon(props: SVGProps<SVGSVGElement>) {
  ...
  return (
    ...
    >
      <path
        d="M7 4.83c0 1.547 1.726 3.178 3.15 4.26c.799.606 1.198.91 1.85.91s1.051-.304 1.85-.91C15.274 8.007 17 6.376 17 4.83c0-2.79-2.75-3.833-5-1.677C9.75.997 7 2.039 7 4.829"
        fill={fill}
      />
      <path
